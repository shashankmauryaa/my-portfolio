...
export default function ContactPage({ onNavigate }) {
  const links = [
    ...
    {
      href: 'https://www.instagram.com/_shashankmaurya/',
      label: 'Instagram',
      external: true,
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    {
      href: 'tel:+917763961399',
      label: 'Phone (+91 7763961399)',
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <div className="page-container page-enter dot-grid-bg">
      <NavigateButton onNavigate={onNavigate} currentPage="contact" />
      ...
      <div className="contact-page">
        ...
        <div className="contact-avatar-capsule">
          <img
            ...
            height="64"
          />
          <span className="contact-avatar-name">Shashank Maurya</span>
        </div>
